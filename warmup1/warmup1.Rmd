...
![](C:\Users\tyler\STAT 133 Lab\images\Pasta.png)
...
In Cartesian coordinates, if **p** $=(p_{1},p_{2},...,p_{n})$ and **q** $=(q_{1},q_{2},...,q_{n})$ are two points in Euclidean *n*\-space, then the distance (d) from **p** to **q**, or from **q** to **p** is given by the Pythagorean formula:$^{[1]}$
